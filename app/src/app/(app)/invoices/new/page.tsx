...
export default async function NewInvoicePage({
    ...
    return (
      <div className="mx-auto max-w-lg">
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-slate-300 bg-white p-10 text-center">
          <p className="text-slate-600">Para crear una factura primero necesitas al menos un cliente.</p>
          <Link
            href="/customers/new"
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-bold text-slate-900">Nueva factura</h1>
