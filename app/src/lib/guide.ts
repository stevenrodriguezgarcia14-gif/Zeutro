...
export const PROFILES: Profile[] = [
  ...
  { slug: "fabricante", label: "Fabricante de productos", emoji: "🏭", desc: "Produces lo que vendes (helados, comida, manualidades…).", playbook: "maker",
    priority: ["products", "profitability", "expenses", "invoices"], recommended: ["customers", "cashflow", "inventory", "purchases"], optional: ["quotations", "projects", "tasks", "sales", "calendar"] },
...
export const MODULES: Record<ModuleSlug, ModuleInfo> = {
  ...
  accounts: { slug: "accounts", name: "Cuentas", href: "/accounts", emoji: "🏦",
    queEs: "Tus cajas y bancos como cuadernos de saldo. Los registras tú: Zentro NO se conecta a tu banco.",
    cuando: "Para saber cuánto dinero tienes registrado y de dónde entra/sale.",
    cuandoNo: "No necesitas una por cada cosa; empieza con caja y banco.",
    errores: "No registrar el saldo inicial, o esperar que se sincronice solo con el banco (no lo hace).",
    relacion: "Se mueve con Pagos, Gastos, Ventas rápidas y transferencias; es la base del Flujo de caja." },
